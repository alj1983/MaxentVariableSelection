...
output: 
  pdf_document:
    toc: true
    highlight: zenburn
bibliography: /home/alj/Dropbox.personal/Dropbox/Literature/CompleteLiteratureMendeley/library.bib
vignette: >
...
Jueterbock A, Smolina I, Coyer JA and Hoarau, G (2015)
...
![ModelSelectionAICc_MarkedMinAICc.png: AICc values of all models, which are ordered along the x-axis based on the applied beta-multiplier. The number of environmental variables included in each model is coded by dot color and size. The model with highest minimum AICc value is marked in red.](/home/alj/Downloads/OutputDirectory/ModelSelectionAUCTest_MarkedMaxAUCTest.png)
...
[//]: create with rmarkdown::render("MaxentVariableSelection.Rmd")


[//]: Refer in the man files more to the paper that I submit and state
