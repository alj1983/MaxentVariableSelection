...
variable selection. The run will take a while, so it is better to
start it in the evening and let it run over night. The resulting
output files will be saved in the folder that you specified in the
argument `outdir`.

The following function starts the model-selection procedure
...
argument `outdir`. If you were patient enough to wait for the
variables selection with our sample settings (see above) to finish,
you will find seven tables and four figures in the output directory.
